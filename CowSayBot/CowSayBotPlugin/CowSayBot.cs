...
namespace CowSayBotPlugin
{
    public class CowSayBot : IPlugin
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="coolDown">The cool down between responding to cowsay commands.  Defaulted to 5 seconds.</param>
        public CowSayBot( int coolDown = 5 )
        {
